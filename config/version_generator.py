...
def parse_master_version_file(file, build_type):
    ...
    SOURCE_VERSION = f"libarch-{build_version_major}{build_version_minor}{build_version_revision}.{source_version_major}.{source_version_minor}"
...
def update_source_version_number(version):
    ...
    SOURCE_VERSION = f"libarch-{version.build_version_major}{version.build_version_minor}{version.build_version_revision}.{version.source_version_major}.{version.source_version_minor}"
...
def write_version_header(header_name, mv_name, template, version):
    ...
    source_version = f"libarch-{build_version_condensed}.{version.source_version_major}.{version.source_version_minor}"

    header = template.render(
        LIBARCH_BUILD_VERSION_MAJOR_VAL=version.build_version_major,
        LIBARCH_BUILD_VERSION_MINOR_VAL=version.build_version_minor,
        LIBARCH_BUILD_VERSION_REVISION_VAL=version.build_version_revision,
        LIBARCH_SOURCE_VERSION_MAJOR_VAL=version.source_version_major,
        LIBARCH_SOURCE_VERSION_MINOR_VAL=version.source_version_minor,
        LIBARCH_BUILD_TYPE_VAL=version.build_type,
        LIBARCH_BUILD_VERSION=build_version,
        LIBARCH_SOURCE_VERSION=source_version,
    )
